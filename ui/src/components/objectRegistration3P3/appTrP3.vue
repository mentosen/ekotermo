<template>
  <tr class="appTr">
    ...
    <td>
      ...
      <div v-if="!isEdit">{{data.roomType}}</div>
    </td>
    <td>
      <div class="btnPart">
        <label>
    ...
    save(e){
      var parent = e.target.closest("tr");
        var obj = {
          ...
          roomType: parent.children[5].children[0].options[parent.children[5].children[0].selectedIndex].innerText,
