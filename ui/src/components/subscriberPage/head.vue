<template>
  <div class="head">
    <div class="headDivsTop">
      <div class="title">Серебряков Александр Николаевич</div>
      <div class="dropMenu" @mouseover="onMenuOver" @mouseout="onMenuOut">
        ...
        <button class="dropMenuItem" @click="showFeedback">{{$t('billingMainPage.feedback')}}</button>
      </div>
    </div>

    <div class="headDivs">
      <div class="addressDiv">Область : Полтавская , город : Горишние Плавни , проспект : Героев Днепра , № дома : 77 , № помещения (а/я) : 86</div>
    </div>
  </div>
</template>
